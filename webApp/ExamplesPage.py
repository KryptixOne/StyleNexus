...
def examplesPage():
    ...
    with col1:
        ...
        st.image('./webApp/ExamplePics/ref3.jpg', use_column_width=True, caption='A (sexy) man modeling a sweater with a messy'
                                                                                 ' background')

        st.image('./webApp/ExamplePics/GirlWearingLion.PNG', use_column_width=True,
    ...
    with col2:
        ...
        st.image('./webApp/ExamplePics/ref1_to_model.png', use_column_width=True, caption='AI Generated Fashion Model '
                                                                                          'wearing a silly unicorn sweater')

        st.image('./webApp/ExamplePics/girlToNewGirl.PNG', use_column_width=True,
